...
Statuses: **Supported** (repository evidence exists today), **Partial** (some evidence; named gaps), **Pending** (no repository evidence; open obligation). Evidence links are to repository files verified on 2026-09-22 unless noted.
...
| System architecture diagram                    | No consolidated diagram; architectural decisions are recorded as ADRs                                                                    | `../adr/` (31 ADR documents, numbers 0001–0030 with a duplicated 0001)                         | Pending (consolidated diagram) |
