...
2. Authorized stewards create **Course assignments** — Gen Ed Coordinator for General Education (college-wide), Program Head for Program-specific within their Authorized Program set, Dean all-program; curriculum placements (PUBLISHED versions) feed the assignment picker ([course-assignments](../../src/features/course-assignments/CONTEXT.md), [curriculum](../../src/features/curriculum/CONTEXT.md)).
...
5. The authorized deployer publishes from an **immutable instrument version** — Faculty on their own assignments, Program Head within scope, Dean/Secretary on behalf — creating one respondent assignment per active roster member minus recorded exclusions, snapshotting CILO/PLO bindings, and locking ordinary roster writes ([instruments](../../src/features/instruments/CONTEXT.md), [evaluations](../../src/features/evaluations/CONTEXT.md), [course-assignments](../../src/features/course-assignments/CONTEXT.md)).
