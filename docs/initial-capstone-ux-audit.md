...
| College Dean                        | The Dean uses System CLOIE for college-level academic structure and oversight.                                                                                              | Review the College dashboard; inspect Programs/Courses; review assignments, instruments, and learning-outcome status.                                                   |
