...
| ----- | ----- | ----- | ----- |
| Cross-role privacy boundaries for response review (identified detail is a Program-Head-only flow) | [src/features/response-review/CONTEXT.md](../../../src/features/response-review/CONTEXT.md); privacy test suites under [src/__tests__/features/response-review/](../../../src/__tests__/features/response-review/) and [e2e/cross-role-privacy.spec.ts](../../../e2e/cross-role-privacy.spec.ts) | Link to an approved stakeholder requirement/objective statement | pending review |
| Curriculum versioning lifecycle (DRAFT → PUBLISHED → RETIRED, published immutability) | [src/features/curriculum/CONTEXT.md](../../../src/features/curriculum/CONTEXT.md); [docs/adr/0013-versioned-curriculum-course-placement.md](../../adr/0013-versioned-curriculum-course-placement.md); curriculum test suites | Link to an approved stakeholder requirement/objective statement (the NOT-automating-curriculum-revision boundary is documented; the versioning feature's originating requirement is not yet surfaced in this repo's decision docs) | pending review |
| One-active Academic Period invariant | [src/features/academic-calendar/CONTEXT.md](../../../src/features/academic-calendar/CONTEXT.md); [src/__tests__/features/academic-calendar/academic-period-one-active-invariant.test.ts](../../../src/__tests__/features/academic-calendar/academic-period-one-active-invariant.test.ts) | Link to an approved stakeholder requirement/objective statement | pending review |
...
| ----- | ----- | ----- | ----- | ----- |
| OBJ-__ | pending | pending | pending | Draft and approve Chapter 1 objectives first |

## E. Requirement Change Log

| Change ID | Date | Req. ID | Change / Decision | Reason / Evidence | Impact on Scope/Design/Test | Approved by |
| ----- | ----- | ----- | ----- | ----- | ----- | ----- |
| CR-__ | pending | pending | pending | pending | pending | pending |
