...
All decisions live in `docs/adr/` — 23 files numbered 0001–0022 (number 0001 exists twice; 0001 single-role is superseded by 0022; 0013 is superseded by 0021). Where a design introduces or reverses a cross-cutting constraint, record a new ADR (rule owned by [AGENTS.md](../../AGENTS.md)).
