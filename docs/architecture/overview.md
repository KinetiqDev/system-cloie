...
All decisions live in `docs/adr/` — 24 files numbered 0001–0023 (number 0001 exists twice; 0001 single-role is superseded by 0022; 0013 is superseded by 0021; 0006 is amended by 0023). Where a design introduces or reverses a cross-cutting constraint, record a new ADR (rule owned by [AGENTS.md](../../AGENTS.md)).

| ADR                                                                                              | Title                                                           | Decision (one line)                                                                                                                                                                                                      |
| ------------------------------------------------------------------------------------------------ | --------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [0001-single-role](../adr/0001-single-role-accounts.md) _(Superseded by ADR 0022)_               | Single-Role Accounts: superseded                                | Accounts were limited to one assigned role; ADR 0022 replaces this with multiple assigned roles and one server-resolved active role.                                                                                     |
...
| [0006](../adr/0006-dean-pwa-offline-cache-contract.md) _(Enrollments scope removed by ADR 0023)_ | Dean PWA Offline Cache Contract                                 | Deferred — would cache last viewed read-only Dean data with timestamp; all mutations require network.                                                                                                                    |
...
| [0022](../adr/0022-multi-role-accounts-with-active-role-context.md)                              | Multi-Role Accounts with Active Role Context                    | Accounts may hold distinct assigned roles; one validated active role controls authorization and profile gating at a time.                                                                                                |
| [0023](../adr/0023-remove-dean-enrollment-oversight.md)                                          | Remove Dean Enrollment Oversight                                | The Dean enrollment totals and roster drill-down are removed with their routes, read-model functions, and wiring; the Enrollments ledger and its Secretary/Student flows are unchanged.                                  |
