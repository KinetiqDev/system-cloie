...
The pull-request job SHALL produce machine-readable JSON and SARIF audit reports by capturing JSON stdout and passing a SARIF output path, and SHALL upload every report produced before status propagation whether the audit passes or fails.
