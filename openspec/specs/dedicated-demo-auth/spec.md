# Dedicated Demo Authentication

## Purpose

Provide a controlled production-mode role-switching capability in an isolated demo deployment for demonstrations and route-performance evidence, while keeping the primary public Production deployment OAuth-only and development authentication separate.
