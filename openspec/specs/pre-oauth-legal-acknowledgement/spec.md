# pre-oauth-legal-acknowledgement

Role-specific Google authentication actions require an accessible legal summary acknowledgement before OAuth begins and preserve the selected role through the existing callback flow.
