# Student ID Deprecation

## Purpose

Define the removal of unverified Student-entered institutional ID from System CLOIE while preserving authoritative Student academic profile, placement, and roster-eligibility rules.
...
- **THEN** Student ID SHALL not be exposed
