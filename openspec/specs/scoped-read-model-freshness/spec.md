# Scoped Read Model Freshness

## Purpose

Define safe shared-read caching boundaries and complete invalidation ownership without persistently caching private or authorization-dependent data.
