...
export const allUsers = [
  { id: U.ADMIN, email: "demo-secretary@cloie.test", name: "Demo Admin", role: SystemRole.SECRETARY },
  { id: U.DEAN, email: "demo-dean@cloie.test", name: "Demo Dean", role: SystemRole.DEAN },
  { id: U.PH_BSIT, email: "demo-ph@cloie.test", name: "Demo Program Head", role: SystemRole.PROGRAM_HEAD },
  { id: U.FAC_BSIT, email: "demo-faculty@cloie.test", name: "Demo Faculty", role: SystemRole.FACULTY },
  { id: U.STU_BSIT, email: "demo-student@cloie.test", name: "Demo Student", role: SystemRole.STUDENT },
  { id: U.GRAD_BSIT, email: "demo-grad@cloie.test", name: "Demo Graduate", role: SystemRole.STUDENT },
  { id: U.ALU_BSIT, email: "demo-alumni@cloie.test", name: "Demo Alumni", role: SystemRole.ALUMNI },
  { id: U.IND_BSIT, email: "demo-industry@cloie.test", name: "Demo Industry", role: SystemRole.INDUSTRY_PARTNER },
  { id: U.PH_BEED, email: "ph-beed@cloie.test", name: "Maria Santos", role: SystemRole.PROGRAM_HEAD },
  { id: U.PH_BSED, email: "ph-bsed@cloie.test", name: "Jose Reyes", role: SystemRole.PROGRAM_HEAD },
  { id: U.PH_BSSW, email: "ph-bssw@cloie.test", name: "Ana Cruz", role: SystemRole.PROGRAM_HEAD },
  { id: U.PH_BSBA, email: "ph-bsba@cloie.test", name: "Roberto Lim", role: SystemRole.PROGRAM_HEAD },
  { id: U.PH_BSHM, email: "ph-bshm@cloie.test", name: "Carmen Flores", role: SystemRole.PROGRAM_HEAD },
  { id: U.PH_MULTI, email: "ph-multi@cloie.test", name: "Daniel Garcia", role: SystemRole.PROGRAM_HEAD },
  { id: U.FAC_BSED, email: "faculty-bsed@cloie.test", name: "Elena Torres", role: SystemRole.FACULTY },
  { id: U.FAC_BSBA, email: "faculty-bsba@cloie.test", name: "Marco Villanueva", role: SystemRole.FACULTY },
  { id: U.FAC_BSHM, email: "faculty-bshm@cloie.test", name: "Lisa Mendoza", role: SystemRole.FACULTY },
  { id: U.STU_BSED, email: "student-bsed@cloie.test", name: "Juan Dela Cruz", role: SystemRole.STUDENT },
  { id: U.STU_BSBA, email: "student-bsba@cloie.test", name: "Angela Reyes", role: SystemRole.STUDENT },
  { id: U.STU_BSBA_G, email: "student-bsba-grad@cloie.test", name: "Carlos Santos", role: SystemRole.STUDENT },
  { id: U.STU_BEED, email: "student-beed@cloie.test", name: "Patricia Luna", role: SystemRole.STUDENT },
  { id: U.STU_BSHM, email: "student-bshm@cloie.test", name: "Daniel Tan", role: SystemRole.STUDENT },
