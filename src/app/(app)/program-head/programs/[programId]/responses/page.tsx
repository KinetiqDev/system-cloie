...
export const metadata = { title: "Responses | Program Head | System CLOIE" };

export default async function SelectedProgramResponsesPage({ params, searchParams }: { params: Promise<{ programId: string }>; searchParams: Promise<Record<string, string | string[] | undefined>> }) {
  ...
  return <ProgramHeadResponsesLanding programId={programId} program={context.data.selectedProgram} state={state} data={data} />;
}
