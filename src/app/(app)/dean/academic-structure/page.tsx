...
export const metadata = { title: buildPageTitle("Academic Structure", "Dean") };
    ...
    <DeanGroupLanding
      ...
      tools={[
        ...
        },
        {
          ...
          description: "Manage the shared course catalog.",
          icon: BookOpen,
        },
        {
          name: "Course Assignments",
          href: "/dean/academic-structure/course-assignments",
          description: "Assign faculty to course contexts.",
          icon: UsersRound,
        },
        {
          name: "Instruments",
          href: "/dean/academic-structure/instruments",
          description: "Manage institutional evaluation instruments.",
          icon: Layers3,
        },
      ]}
    />
