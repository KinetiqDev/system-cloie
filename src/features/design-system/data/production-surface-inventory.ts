...
export const PRODUCTION_SURFACE_INVENTORY: InventoryEntry[] = [
  ...
  {
    path: "src/features/academic-structure/components/course-import-dialog.tsx",
    disposition: "task",
    taskId: 14,
    category: "feature_component",
  },
  ...
  {
    path: "src/features/course-assignments/components/gen-ed-dashboard-assignment-launcher.tsx",
    disposition: "task",
    taskId: 12,
    category: "feature_component",
  },
